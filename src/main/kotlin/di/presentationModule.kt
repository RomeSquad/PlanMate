...
val presentationModule = module {
    ...
    single { LoginManagementUI(get(), get(), get()) }
    single { MainMenuUI(get(), get(), get()) }
    single { AdminManagementUI(get(), get(), get(), get(), get(), get(), get()) }
    single { MateManagementUI(get()) }
    single { CreateUserUi(get()) }
    single { DeleteUserUi(get(), get()) }
    single { EditUserUI(get(), get()) }
    single { ViewAllUserUI(get()) }

    single { ProjectManagementUI(get(), get(), get(), get(), get(), get(), get()) }
    single { CreateProjectUi(get(), get(), get(), get(), get(), get()) }
    single { DeleteProjectUi(get(), get()) }
    single { EditProjectUi(get(), get(), get(), get()) }
    single { ListProjectUi(get()) }

    single { ProjectStateManagementUI(get(), get(), get(), get(), get()) }
    single { AddStateToProjectUI(get(), get(), get()) }
    single { AddTaskStateToProjectUI(get(), get()) }
    single { EditProjectStateUI(get(), get()) }
    single { DeleteStateToProjectUI(get(), get(), get()) }
    single { GetAllStatesPerProjectUI(get(), get()) }

    single { TaskManagementUI(get(), get(), get(), get(), get()) }
    single { CreateTaskUI(get(), get(), get(), get(), get(), get()) }
    single { DeleteTaskUI(get(), get(), get(), get(), get()) }
    single { EditTaskUI(get(), get(), get(), get(), get(), get()) }

    single { SwimlanesView(get(), get()) }
    single { ShowTaskHistoryUI(get(), get(), get()) }
    single { ShowProjectHistoryUI(get(), get()) }
    single { ShowHistoryManagementUI(get(), get()) }
